  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            ...
            <span className='text-sm font-inter py-1.5 px-3 text-white bg-orange-500 rounded-full'>20% OFF</span>
        </div>
        ...
        <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
         ...
         <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores tempora laboriosam obcaecati nobis dicta molestiae esse earum delectus reprehenderit, nesciunt cupiditate commodi hic sint dolor ducimus quibusdam saepe magni aliquam at doloremque, in sit assumenda distinctio. Aspernatur, tenetur voluptatibus! Ducimus amet harum error laudantium quam at aliquid nisi similique mollitia.</p>
         </div>
